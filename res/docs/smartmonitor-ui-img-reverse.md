...
These addresses are from `WIND/3.5 Inch SmartMonitor.exe` unpacked to `/tmp/smartmonitor_unpacked/app`.
...
- [library/smartmonitor_compile.py](/home/lord/Документы/PROJECT%20CODEX/turing-smart-screen-python-main/library/smartmonitor_compile.py:1)
- [tools/smartmonitor-compile-theme.py](/home/lord/Документы/PROJECT%20CODEX/turing-smart-screen-python-main/tools/smartmonitor-compile-theme.py:1)
...
- A native `.ui` decoder now exists in:
  - [tools/smartmonitor-decode-ui.py](/home/lord/Документы/PROJECT%20CODEX/turing-smart-screen-python-main/tools/smartmonitor-decode-ui.py:1)
- A native `.ui` parser/inspector now exists in:
  - [library/smartmonitor_ui.py](/home/lord/Документы/PROJECT%20CODEX/turing-smart-screen-python-main/library/smartmonitor_ui.py:1)
  - [tools/smartmonitor-inspect-ui.py](/home/lord/Документы/PROJECT%20CODEX/turing-smart-screen-python-main/tools/smartmonitor-inspect-ui.py:1)
- A partial `img.dat` inspector now exists in:
  - [library/smartmonitor_imgdat.py](/home/lord/Документы/PROJECT%20CODEX/turing-smart-screen-python-main/library/smartmonitor_imgdat.py:1)
  - [tools/smartmonitor-inspect-imgdat.py](/home/lord/Документы/PROJECT%20CODEX/turing-smart-screen-python-main/tools/smartmonitor-inspect-imgdat.py:1)
- A round-trip `img.dat` reassembler now exists in:
  - [tools/smartmonitor-roundtrip-imgdat.py](/home/lord/Документы/PROJECT%20CODEX/turing-smart-screen-python-main/tools/smartmonitor-roundtrip-imgdat.py:1)
- A source/binary compare tool now exists in:
  - [tools/smartmonitor-compare-theme-imgdat.py](/home/lord/Документы/PROJECT%20CODEX/turing-smart-screen-python-main/tools/smartmonitor-compare-theme-imgdat.py:1)
