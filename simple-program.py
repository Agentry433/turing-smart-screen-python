...
# - A_HID  for Linux hidraw/HID transport using the rev.A protocol (experimental)
...
if __name__ == "__main__":
    ...
    if REVISION == "A":
        ...
        logger.info("Selected Hardware Revision A over Linux HID/hidraw (experimental)")
        lcd_comm = LcdCommRevAHid(com_port=COM_PORT, display_width=WIDTH, display_height=HEIGHT)
    elif REVISION == "B":
