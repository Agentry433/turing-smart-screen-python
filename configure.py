...
DEFAULT_SMARTMONITOR_VENDOR_THEME_ROOT = "/tmp/smartmonitor_unpacked/app/themefor3.5"
    ...
    def save_config_values(self):
        ...
        if self.is_smartmonitor_model() and self.theme_cb.get():
            ...
            self.config['display']['SMARTMONITOR_HID_UPLOAD_ON_START'] = (
                os.path.abspath(previous_smartmonitor_theme) != selected_smartmonitor_theme
            )
